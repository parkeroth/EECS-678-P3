...
../userprog/nachos -x ../test/nice_free --dsui-output nachos.dsui.bin -i $1 -R $2 > temp.out
...
../userprog/nachos -x ../test/nice_free --dsui-output nachos.dsui.bin -i $1 -R $2 > /dev/null
#make -sf Makefile.histos
make histo_postprocess
