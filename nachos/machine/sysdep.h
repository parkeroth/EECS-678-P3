...
#pragma interface "machine/sysdep.h"
...
extern void Read(int fd, void *buffer, size_t nBytes);
extern void Write(int fd, void *buffer, size_t nBytes);
extern int ReadPartial(int fd, void *buffer, size_t nBytes);
extern void WriteFile(int fd, void *buffer, size_t nBytes);
