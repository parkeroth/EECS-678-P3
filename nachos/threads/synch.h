...
// The following class defines a "kernal semaphore" whose value is a
// non-negative integer.  The semaphore has only two operations P() and V():
//
...
class KernelSemaphore {
 public:
  KernelSemaphore(char* debugName, int initialValue)
    : name(debugName), value(initialValue) {}
  ~KernelSemaphore();   					// deallocate semaphore
