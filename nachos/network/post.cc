...
// First, initialize the synchronization with the interrupt handlers
    messageAvailable = new KernelSemaphore("message available", 0);
    messageSent = new KernelSemaphore("message sent", 0);
